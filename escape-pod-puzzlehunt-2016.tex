...
You should \textbf{print this fieldbook} and
bring it with you into the field on your upcoming mission.

To solve these puzzles, you will need the \textbf{ClueKeeper} app on
an iOS or Android phone or tablet. Download the mission
``Von Braun's Puzzlehunt'' and use the code \texttt{OFFICE} to
begin. For more information, visit \phUrl{http://ephunt16.clontz.org}.
Good luck!
